...
map.getView().fit([12294063.621934, -787696.043981, 12294754.007226, -787316.438562], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">PETA PERSEBARAN BENCHMARK (BM) DI POLITEKNIK PEKERJAAN UMUM</h2>';
        return titleElement;
    })(),
